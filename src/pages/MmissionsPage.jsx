...
const timelineData = [
  ...
  },
  {
    ...
    highlights: {
      preview: (
        <ul>
          <li><strong>1st Place Championship Trophy</strong> – Overall winners of the competition out of 300+ participants</li>
  ...
  },
  {
    ...
    highlights: {
      preview: (
        <ul>
          <li><strong>6th Place Overall</strong> – Outperforming over 50 teams from across the country in a highly competitive field.</li>
